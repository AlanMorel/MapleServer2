...
namespace Maple2Storage.Utils
{
    public static class Serialization
    {
        ...
        public static byte[] SerializeDictionary(this object obj)
        {
            throw new NotImplementedException();
        }
        // Take a Collection and save it into a byte[]
        public static byte[] SerializeCollection(this object obj)
        {
            throw new NotImplementedException();
        }

        // Take a Collection<T> and save it into a byte[]
        public static byte[] SerializeCollection<T>(this object obj)
        {
            throw new NotImplementedException();
        }
        ...
        public static IDictionary<T, A> DeserializeDictionary<T, A>(this object dictionary)
        {
            throw new NotImplementedException();
        }

        // Take a byte[] and convert the data into a ICollection of T
        public static ICollection<T> DeserializeCollection<T>(this object collection)
        {
            throw new NotImplementedException();
        }

        // Take a byte[] and convert the data into a Collection of 2 parameters, T & A
        public static T DeserializeCollection<T, A>(this object collection)
        {
            throw new NotImplementedException();
        }
    }
