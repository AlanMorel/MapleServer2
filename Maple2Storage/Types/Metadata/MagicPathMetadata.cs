...
namespace Maple2Storage.Types.Metadata
{
    ...
    public class MagicPathMetadata
    {
        ...
        [XmlElement(Order = 2)]
        public readonly List<MagicPathMove> MagicPathMoves = new List<MagicPathMove>();

        public MagicPathMetadata()
        {
            MagicPathMoves = new List<MagicPathMove>();
        }
        ...
        public override string ToString() => $"ID:{Id} {string.Join(",", MagicPathMoves)}";
    }
    ...
    public class MagicPathMove
    {
        ...
        public override string ToString() => $"Rotation:{Rotation}, FireOffsetPos:{FireOffsetPosition}," +
