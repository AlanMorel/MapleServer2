...
public enum SendOp : ushort
{
    ...
    FIELD_ADD_PLAYER = 0x0017,
    FIELD_REMOVE_PLAYER = 0x0018,
    DUNGEON_LIST = 0x0019,
    ROOM_DUNGEON = 0x001A,
    RESULTS = 0x001B,
    USER_SYNC = 0x001C,
    ...
    ITEM_REPACKAGE = 0x00E6,
    MAPLEOPOLY = 0x00E7,
    BYPASS_KEY = 0x00E8,
    LOCAL_CAMERA = 0x00EB,
    RESPONSE_HOME_ACTION = 0x00EC,
    PREMIUM_CLUB = 0x00ED,
    ...
    ROCK_PAPER_SCISSORS = 0x0116,
    MUSHKING_ROYALE = 0x0118,
    MUSHKING_ROYALE_SYSTEM = 0x011B,
    SPECTATE = 0x011C,
