...
namespace MapleServer2.Constants.Skills
{
    public static class SkillTreeOrdered
    {
        ...
        private static readonly int[] None = new int[]
        {
            0
        };
        ...
        private static readonly int[] Berserker = new int[]
        {
        ...
        private static readonly int[] Wizard = new int[]
        {
        ...
        private static readonly int[] Priest = new int[]
        {
        ...
        private static readonly int[] Archer = new int[]
        {
        ...
        private static readonly int[] HeavyGunner = new int[]
        {
        ...
        private static readonly int[] Thief = new int[]
        {
        ...
        private static readonly int[] Assassin = new int[]
        {
        ...
        private static readonly int[] Runeblade = new int[]
        {
        ...
        private static readonly int[] Striker = new int[]
        {
        ...
        private static readonly int[] SoulBinder = new int[]
        {
        ...
        private static readonly int[] GameMaster = new int[]
        {
            0
        };
        #endregion
        ...
        private static readonly int[] KnightDefault = new int[]
        {
            10100061,10100091
        };
        private static readonly int[] BerserkerDefault = new int[]
        {
            10200031,10200091
        };
        private static readonly int[] WizardDefault = new int[]
        {
            10300061,10300081
        };
        private static readonly int[] PriestDefault = new int[]
        {
            10400111,10400151
        };
        private static readonly int[] ArcherDefault = new int[]
        {
            10500111,10500151
        };
        private static readonly int[] HeavyGunnerDefault = new int[]
        {
            10600071,10600081
        };
        private static readonly int[] ThiefDefault = new int[]
        {
            10700041,10700042,10700061
        };
        private static readonly int[] AssassinDefault = new int[]
        {
            10800071,10800081
        };
        private static readonly int[] RunebladeDefault = new int[]
        {
            10900041,10900051
        };
        private static readonly int[] StrikerDefault = new int[]
        {
            11000051,11000053,11000055,11000081
        };
        private static readonly int[] SoulBinderDefault = new int[]
        {
            11100051,11100061
        };
        #endregion
        ...
        /// </summary>
        public static int[] GetListOrdered(Job job)
        {
            switch (job)
            {
                case Job.Knight:
        ...
        /// </summary>
        public static int[] GetDefaultLearnedSkill(Job job)
        {
            switch (job)
            {
                case Job.Knight:
