...
namespace MapleServer2.Packets
{
    public static class ClubPacket
    {
        ...
        public static Packet UpdateClub(Club club, string clubName)
        {
            ...
            pWriter.WriteByte((byte) Mode.UpdateClub);
        ...
        {
            PacketWriter pWriter = PacketWriter.Of(SendOp.CLUB);
            pWriter.WriteByte((byte) Mode.Establish);
            pWriter.WriteLong(club.Id);
            pWriter.WriteUnicodeString(club.Name);
            return pWriter;
        }
        ...
        {
            PacketWriter pWriter = PacketWriter.Of(SendOp.CLUB);
            pWriter.WriteByte((byte) Mode.Create);
            pWriter.WriteLong(club.Id);
            pWriter.WriteUnicodeString(club.Name);
        ...
        {
            PacketWriter pWriter = PacketWriter.Of(SendOp.CLUB);
            pWriter.WriteByte((byte) Mode.InviteSentReceipt);
        ...
        {
            PacketWriter pWriter = PacketWriter.Of(SendOp.CLUB);
            pWriter.WriteByte((byte) Mode.Invite);
            pWriter.WriteLong(club.Id);
            pWriter.WriteUnicodeString(club.Name);
            pWriter.WriteUnicodeString(club.Leader.Name);
            pWriter.WriteUnicodeString(other.Name);
        ...
        {
            PacketWriter pWriter = PacketWriter.Of(SendOp.CLUB);
            pWriter.WriteByte((byte) Mode.InviteResponse);
            pWriter.WriteLong(club.Id);
            pWriter.WriteUnicodeString(club.Name);
            pWriter.WriteUnicodeString(club.Leader.Name);
        ...
        {
            PacketWriter pWriter = PacketWriter.Of(SendOp.CLUB);
            pWriter.WriteByte((byte) Mode.LeaderInviteResponse);
            pWriter.WriteLong(club.Id);
        ...
        {
            PacketWriter pWriter = PacketWriter.Of(SendOp.CLUB);
            pWriter.WriteByte((byte) Mode.LeaveClub);
            pWriter.WriteLong(club.Id);
            return pWriter;
        }
        ...
        {
            PacketWriter pWriter = PacketWriter.Of(SendOp.CLUB);
            pWriter.WriteByte((byte) Mode.ChangeBuffReceipt);
            pWriter.WriteLong(club.Id);
        ...
        {
            PacketWriter pWriter = PacketWriter.Of(SendOp.CLUB);
            pWriter.WriteByte((byte) Mode.ConfirmCreate);
            pWriter.WriteLong(clubId);
            pWriter.WriteInt();
            pWriter.WriteShort();
            return pWriter;
        ...
        {
            PacketWriter pWriter = PacketWriter.Of(SendOp.CLUB);
            pWriter.WriteByte((byte) Mode.Disband);
            pWriter.WriteLong(club.Id);
            pWriter.WriteUnicodeString(club.Leader.Name);
        ...
        {
            PacketWriter pWriter = PacketWriter.Of(SendOp.CLUB);
            pWriter.WriteByte((byte) Mode.ConfirmInvite);
            pWriter.WriteLong(club.Id);
            pWriter.WriteUnicodeString(club.Leader.Name);
        ...
        {
            PacketWriter pWriter = PacketWriter.Of(SendOp.CLUB);
            pWriter.WriteByte((byte) Mode.LeaveNotice);
            pWriter.WriteLong(club.Id);
            pWriter.WriteUnicodeString(player.Name);
            return pWriter;
        }
        ...
        {
            PacketWriter pWriter = PacketWriter.Of(SendOp.CLUB);
            pWriter.WriteByte((byte) Mode.LogoutNotice);
            pWriter.WriteLong(club.Id);
            pWriter.WriteUnicodeString(player.Name);
            pWriter.WriteLong(); // current timestamp
            return pWriter;
        ...
        {
            PacketWriter pWriter = PacketWriter.Of(SendOp.CLUB);
            pWriter.WriteByte((byte) Mode.AssignNewLeader);
            pWriter.WriteLong(club.Id);
            pWriter.WriteUnicodeString(player.Name);
        ...
        {
            PacketWriter pWriter = PacketWriter.Of(SendOp.CLUB);
            pWriter.WriteByte((byte) Mode.ChangeBuff);
            pWriter.WriteLong(club.Id);
            pWriter.WriteInt(buffId);
            pWriter.WriteInt(0x1);
            return pWriter;
        ...
        {
            PacketWriter pWriter = PacketWriter.Of(SendOp.CLUB);
            pWriter.WriteByte((byte) Mode.UpdatePlayerClubList);
            pWriter.WriteLong(club.Id);
            pWriter.WriteUnicodeString(player.Name);
        ...
        {
            PacketWriter pWriter = PacketWriter.Of(SendOp.CLUB);
            pWriter.WriteByte((byte) Mode.LoginNotice);
            pWriter.WriteLong(club.Id);
            pWriter.WriteUnicodeString(player.Name);
            return pWriter;
        }
        ...
        {
            PacketWriter pWriter = PacketWriter.Of(SendOp.CLUB);
            pWriter.WriteByte((byte) Mode.Rename);
            pWriter.WriteLong(club.Id);
        ...
        {
            PacketWriter pWriter = PacketWriter.Of(SendOp.CLUB);
            pWriter.WriteByte((byte) Mode.Join);
            pWriter.WriteLong(club.Id);
            pWriter.WriteUnicodeString(player.Name);
            pWriter.WriteUnicodeString(club.Name);
            return pWriter;
