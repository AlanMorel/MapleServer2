...
public class PlayerStats
{
    ...
    public void InitializePools(int hp, int spirit, int stamina)
    {
        ...
        Data[PlayerStatId.Hp] = new(hpStat.Max, hpStat.Min, hp);
        Data[PlayerStatId.Spirit] = new(spiritStat.Max, spiritStat.Min, spirit);
        Data[PlayerStatId.Stamina] = new(staStat.Max, staStat.Min, stamina);
    }

    public void IncreaseMax(PlayerStatId statIndex, int amount)
    {
        PlayerStat stat = this[statIndex];
        Data[statIndex] = new(stat.Max + amount, stat.Min, stat.Current + amount);
    }

    public void IncreaseBase(PlayerStatId statIndex, int amount)
    {
        PlayerStat stat = this[statIndex];
        Data[statIndex] = new(stat.Max + amount, stat.Min + amount, stat.Current + amount);
    }
    ...
    public void Increase(PlayerStatId statIndex, int amount)
    {
        ...
        Data[statIndex] = new(stat.Max, stat.Min, newCurrent);
    }
    ...
    public void DecreaseMax(PlayerStatId statIndex, int amount)
    {
        ...
        Data[statIndex] = new(newMax, stat.Min, newCurrent);
    }
    ...
    {
        PlayerStat stat = this[statIndex];
        Data[statIndex] = new(stat.Max, stat.Min, stat.Current - amount);
    }
