...
namespace MapleServer2.Types
{
    public class Player
    {
        ...
        public static Player Char1(long accountId, long characterId, string name = "Char1")
        {
            ...
            player.Inventory.Equips = new Dictionary<ItemSlot, Item> {
                { ItemSlot.ER, Item.Ear() },
                { ItemSlot.HR, Item.Hair() },
                { ItemSlot.FA, Item.Face() },
                { ItemSlot.FD, Item.FaceDecoration() }
            };
            player.Inventory.Equips.Add(ItemSlot.RH, Item.TutorialBow(player));
            return player;
        }
        ...
        public static Player Priest(long accountId, long characterId, string name = "Priest")
        {
            ...
            player.Inventory.Equips.Add(ItemSlot.RH, Item.DefaultScepter(player));
            player.Inventory.Equips.Add(ItemSlot.LH, Item.DefaultCodex(player));
            return player;
        }
