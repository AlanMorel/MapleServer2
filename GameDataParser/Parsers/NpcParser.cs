...
public class NpcParser : Exporter<List<NpcMetadata>>
{
    ...
    private static NpcStats GetNpcStats(XmlAttributeCollection collection)
    {
        ...
        npcStats.Cap = new(int.Parse(collection["cap"].Value));
        npcStats.Cad = new(int.Parse(collection["cad"].Value));
        npcStats.Car = new(int.Parse(collection["car"].Value));
        npcStats.Ndd = new(int.Parse(collection["ndd"].Value));
        npcStats.Abp = new(int.Parse(collection["abp"].Value));
